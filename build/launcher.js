	  ...
	  _createClass(StaticServerLauncher, [{
	    ...
	    value: function onPrepare(_ref) {
	      ...
	      var folders = _ref.staticServerFolders,
	          ...
	          fallback = _ref$staticServerFall === undefined ? false : _ref$staticServerFall,
	          _ref$staticServerFall2 = _ref.staticServerFallbackFile,
	          fallbackFile = _ref$staticServerFall2 === undefined ? 'index.html' : _ref$staticServerFall2;
	      ...
	      (Array.isArray(folders) ? folders : [folders]).forEach(function (folder) {
	        ...
	        if (fallback) {
	          _this.log.debug('Using `%s` as 404 fallback', fallbackFile);
	          _this.server.use(function (req, res) {
	            res.status(200).sendFile(_path2.default.resolve(fallbackFile));
	          });
	        }
	      });
